 ...
 */
public abstract class TypeReference<T extends cc.youchain.abi.datatypes.Type>
    ...
    public static <T extends cc.youchain.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends cc.youchain.abi.datatypes.Type>
