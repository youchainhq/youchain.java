...
/**
 * Java wrapper source code generator for YOUBox JSON format. YOUBox embeds the Solidity ABI
 * formatted JSON in its own format. That format also gives access to the binary code. It also
 * contains information about deployment addresses. This should make integration with YOUBox
 * easier.
 */
public class YOUBoxJsonFunctionWrapperGenerator extends FunctionWrapperGenerator {

    private static final String USAGE = "youbox generate "
            + "[--javaTypes|--solidityTypes] "
            + "<input youbox json file>.json "
    ...
    private YOUBoxJsonFunctionWrapperGenerator(
    ...
    public static void main(String[] args) throws Exception {
        ...
        new YOUBoxJsonFunctionWrapperGenerator(
                jsonFileLocation,
    ...
    /**
     * YOUBox Contract <p> Describes a contract exported by and consumable by YOUBox, which may
    ...
    public static class Contract {
         ...
         *
         * @param network the contract's address on this YOUChain network
