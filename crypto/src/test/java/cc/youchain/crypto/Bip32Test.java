...
import static cc.youchain.crypto.Bip32ECKeyPair.HARDENED_BIT;
...
public class Bip32Test {
    ...
    private void testGenerated(String seed, String expectedPriv, String expectedPub, int[] path) {
        ...
        Assert.assertEquals(expectedPriv, Base58.encode(addChecksum(serializePrivate(pair))));
        Assert.assertEquals(expectedPub, Base58.encode(addChecksum(serializePublic(pair))));
    }
