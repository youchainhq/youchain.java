...
public class Request<S, T extends Response> {
    ...
    private YOUChainService youChainService;
    ...
    public Request(String method, List<S> params,
                   YOUChainService youChainService, Class<T> type) {
        this.method = method;
        this.params = params;
    ...
    public T send() throws IOException {
        return youChainService.send(this, responseType);
    }

    public CompletableFuture<T> sendAsync() {
        return  youChainService.sendAsync(this, responseType);
    }
