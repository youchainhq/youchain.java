 ...
 */
public class YOUSyncing extends Response<YOUSyncing.Result> {

    @Override
    @JsonDeserialize(using = YOUSyncing.ResponseDeserialiser.class)
    public void setResult(YOUSyncing.Result result) {
