...
public interface YOUChainRx {
     ...
     * blockchain
     */
    Flowable<YOUBlock> blockFlowable(boolean fullTransactionObjects);
     ...
     */
    Flowable<YOUBlock> replayPastBlocksFlowable(
     ...
     *                               in the {@link YOUBlock} responses
     ...
     */
    Flowable<YOUBlock> replayPastAndFutureBlocksFlowable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
